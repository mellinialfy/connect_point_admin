					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="assets/media/my_icons/logo_connect_point_white.ico">
								</a>
							</div>
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Log In Admin</h3>
								</div>
								<form class="kt-form" action="">
									...
									<div class="kt-login__actions">
										<button id="kt_login_signin_submit" class="btn btn-pill kt-login__btn-primary">Masuk</button>
									</div>
								</form>
							</div>
							<div class="kt-login__signup">
								...
								<div class="kt-login__head">
									...
									<div class="kt-login__desc">Masukkan data anda untuk membuat akun:</div>
								</div>
								<form class="kt-login__form kt-form" id="signup_form" action="halaman/register_admin.php" method="POST">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Nama Lengkap" name="fullname">
									</div>
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Email" name="email" autocomplete="off">
									</div>
									...
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Konfirmasi Password" name="rpassword">
									</div>
									<!--<div class="row kt-login__extra">-->
									...
									<!--</div>-->
									<div class="kt-login__actions">
										<button id="kt_login_signup_submit" class="btn btn-pill kt-login__btn-primary" type="submit" name="submit">Daftar</button>&nbsp;&nbsp;
										<button id="kt_login_signup_cancel" class="btn btn-pill kt-login__btn-secondary">Batal</button>
									</div>
								</form>
							</div>
							<div class="kt-login__forgot">
								...
								<form class="kt-form" action="">
									...
									<div class="kt-login__actions">
										...
										<button id="kt_login_forgot_cancel" class="btn btn-pill kt-login__btn-secondary">Batal</button>
									</div>
								</form>
							</div>
							...
							<!--	</span>&nbsp;&nbsp;-->
							<!--	<a href="javascript:;" id="kt_login_signup" class="kt-link kt-link--light kt-login__account-link">Daftar</a>-->
							<!--</div>-->
						</div>
					</div>
				</div>
