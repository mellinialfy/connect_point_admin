<?php
$title = 'Informasi Penyelenggara Acara';

include "connection.php";

$id_user = $_GET['id'];

$sql="SELECT nama_user, email, username, image_user, website, alamat, desc_user, status_user, verify_reason, instansi, surat_izin_usaha, npwp, ktp  FROM `tb_user` LEFT JOIN tb_instansi ON tb_instansi.id_instansi = tb_user.id_instansi WHERE id_user=$id_user";
	...
	<form class="kt-form kt-form--label-right">
		<div class="kt-portlet__body">
			...
			<div class="form-group row">
				...
				<!--<div class="col-lg-6" onload="loadMap()">-->
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    <label>File Penyelenggara Acara:</label>
                    <div class="row">
                        <?php echo ($ktp!= null || '' ? '
                        <div class="col-md-4">
