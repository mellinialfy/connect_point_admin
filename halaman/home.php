				...
				<div class="kt-widget17">
					...
					<div class="kt-widget17__stats">
						<div class="kt-widget17__items">
							<div class="kt-widget17__item" onclick="location.href='index.php?page=tenant';">
								...
								<span class="kt-widget17__desc">
								    ...
								    $sql="SELECT COUNT(id_user) AS jumlah_tenant FROM `tb_user` WHERE id_jenis_user=1 AND status_user IN(0,2,3)";
								    $tenant=mysqli_query($connect,$sql);
								    
								    while($row=mysqli_fetch_assoc($tenant)){
								        echo $row['jumlah_tenant'],' Pengguna';
							...
							<div class="kt-widget17__item" onclick="location.href='index.php?page=eo';">
								<span class="kt-widget17__icon">
								    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect id="bound" x="0" y="0" width="24" height="24"/>
								...
								<span class="kt-widget17__desc">
								    ...
								    $sql="SELECT COUNT(id_user) AS jumlah_eo FROM `tb_user` WHERE id_jenis_user=2 AND status_user IN(0,2,3)";
								    $eo=mysqli_query($connect,$sql);
								    
								    while($row=mysqli_fetch_assoc($eo)){
								        echo $row['jumlah_eo'],' Pengguna';
						...
						<div class="kt-widget17__items">
							<div class="kt-widget17__item" onclick="location.href='index.php?page=verif_pengguna';">
								<span class="kt-widget17__icon">
								    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect id="bound" x="0" y="0" width="24" height="24"/>
								...
								<span class="kt-widget17__desc">
								    ...
								    $sql="SELECT COUNT(id_user) AS minta_verif FROM `tb_user` WHERE id_jenis_user IN(1,2) AND status_user=3";
								    $result=mysqli_query($connect,$sql);
								    
								    while($row=mysqli_fetch_assoc($result)){
								        echo $row['minta_verif'],' Pengguna';
							...
							<div class="kt-widget17__item" onclick="location.href='index.php?page=verified';">
								<span class="kt-widget17__icon">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect id="bound" x="0" y="0" width="24" height="24"/>
								...
								<span class="kt-widget17__desc">
								    ...
								    $sql="SELECT COUNT(id_user) AS verified FROM `tb_user` WHERE id_jenis_user IN(1,2) AND status_user=2";
								    $verified=mysqli_query($connect,$sql);
								    
								    while($row=mysqli_fetch_assoc($verified)){
								        echo $row['verified'],' Pengguna';
