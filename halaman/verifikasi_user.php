...
<div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body">
        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
			...
			$sql="SELECT id_user, nama_user, username, email, jenis_user FROM `tb_user` JOIN tb_jenis_user ON tb_jenis_user.id_jenis_user = tb_user.id_jenis_user WHERE tb_user.status_user=3 ORDER BY tb_user.updated_at";
